...
<tr>
      ...
      <td><div style="text-align:right; margin:5px 10px 5px 0px"><a href="${pageContext.request.contextPath}/index.do">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath }/dispacher.do?type=final">&nbsp;${user.loginid }</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;用户信息修改</div>
  ...
  <tr>
    ...
    <td style="padding-left:20px">${user.loginid }</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input type="password" class="textinput" name="upasswordconfirm"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
		  ...
		  <table width="100%" border="0" cellspacing="2" class="upline">
            <tr>
              ...
              <td width="47%" style="width:50%"><select name="uquestion" class="textinput" style="width:230px; height:20px">
                  <option value="">${passwordanswer.aquestion }</option>
            ...
            <tr>
              ...
              <td colspan="2"><input name="answer" type="text" class="textinput" value="${passwordanswer.answer }"/>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <font color="#999999">不能少于4个字符，不区分大小写</font></td>
            </tr>
            <tr>
              <td style="text-align:right">备用邮箱：</td>
              <td><input name="email" type="text" class="textinput" value="${passwordanswer.email }"/></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td style="text-align:right">&nbsp;</td>
