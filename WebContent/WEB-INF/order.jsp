          ...
          <td><table width="100%" border="0" cellspacing="0">
              <tr>
                <td><img src="images/buy2.gif" width="635" height="38" />
                  <p>早上好：${user.loginid }<c:if test="${user.usex=='男' }">先生</c:if><c:if test="${user.usex=='女' }">女士</c:if>！欢迎您来到商城结算中心</p></td>
              </tr>
              <tr>
                <td><table cellspacing="1" class="carttable">
				 ...
				 <table cellspacing="1" class="carttable">
				   ...
				   收货人：&nbsp;&nbsp;&nbsp;&nbsp;<input name="text" type="text" value="${user.loginid }" style="width:150px"/>&nbsp;&nbsp;&nbsp;&nbsp;<a href="#">【确认】</a><br/>
