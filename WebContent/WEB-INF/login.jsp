            ...
            <table width="85%" border="0" cellspacing="0">
              <tr>
                ...
                <div id="logindiv">
                        ...
                        <td style="text-align:center"><table width="80%" border="0" cellspacing="0" style="margin-top:15px ;margin-left:auto; margin-right:auto">
                            ...
                            <tr>
                              <td colspan="2" style="text-align:center"><input type="checkbox" name="chk" value="chk" />
                                &nbsp;&nbsp;记住密码<font color='red'>(默认七天)</font></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td colspan="2" style="padding-top:10px; text-align:center"><a href="${pageContext.request.contextPath }/dispacher.do?type=reg"><input name="image" type="image" src="images/signupbutton.gif" width="135" height="33"/></a></td>
                            </tr>
                        </table></td>
                      </tr>
                    </table>
                 ...
                 <c:if test="${cookie.uloginid!=null ||sessionScope.user!=null}">
                 	欢迎：${sessionScope.user.loginid }</br>
                ...
                <td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
                  ...
                  <p style="text-align:right">
                    <a href="${pageContext.request.contextPath }/dispacher.do?type=reg"><input name="image" type="image" src="${pageContext.request.contextPath }/images/signupbutton.gif" width="135" height="33"/></a>
                  </p></td>
              </tr>
            </table>
          </div>
