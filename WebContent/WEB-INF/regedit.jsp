...
<table width="70%" border="0" cellspacing="2" class="upline">
  <tr>
    ...
    <td><img src="${pageContext.request.contextPath }/images/check_use.gif" width="111" height="24" /><span id="sp1"></span></td>
  </tr>
  <tr>
    <td style="text-align:right">会员名：</td>
    <td><input type="text" class="textinput" name="uloginid" id="uname"/></td>
    <td><img src="${pageContext.request.contextPath }/images/check_use.gif" width="111" height="24" id="check_user"/><span id="sp2"></span></td>
  </tr>
  <tr>
    <td style="text-align:right">密码：</td>
    <td><input type="password" class="textinput" name="upassword" id="upassword"/></td>
    <td><font id="fn"></font></td>
  </tr>
  <tr>
    <td style="text-align:right">重复密码：</td>
    <td><input type="password" class="textinput" name="upasswordconfirm" id="upasswordconfirm"/></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
