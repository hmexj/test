package org.lanqiao.util;
	...
	public class Mailutil {
		...
		static final String AUTH_PASSWORD="cfhlczqzcasujchc";
		static final String FROM="1412339204@163.com";//发送邮件的账号（公司固定账号）
		...
		public static void sendMail(String go,String subject,String content){
			...
			try {
				message.setFrom(new InternetAddress(FROM,"棠哥","utf-8"));
